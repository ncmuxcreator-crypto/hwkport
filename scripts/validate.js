...
if (!dbLib.includes('.from("vessel_entities")') || !dbLib.includes('.from("risk_history")') || !dbLib.includes('.from("vessel_events")') || !dbLib.includes('.from("data_collection_runs")') || !dbLib.includes('.from("active_dataset_pointer")') || !dbLib.includes('.from("enrichment_match_candidates")') || !dbLib.includes('.from("commercial_leads")') || !dbLib.includes('.from("feature_store")') || !dbLib.includes('.from("rule_evaluations")') || !dbLib.includes('.from("model_training_rows")')) {
