...
for (const marker of ["data_collection_runs", "active_dataset_pointer", "vessel_master", "vessel_aliases", "vessel_identity_candidates", "vessel_entities", "vessel_events", "risk_history", "port_congestion_snapshots", "anchorage_clusters", "berth_occupancy_history", "route_patterns", "vessel_route_history", "predicted_arrivals", "enrichment_match_candidates", "commercial_leads", "berth_aliases", "terminal_aliases", "payload jsonb", "hybrid_entity_key", "run_id", "master_vessel_id", "commercial_value_score", "data_confidence_score", "lead_status", "last_contacted_at", "follow_up_due", "quote_status", "notes", "lead_priority_score", "why_now", "candidate_summary_ko", "prediction_error_hours", "alert_candidate", "predicted_congestion_score", "anchorage_probability", "predicted_work_window_hours", "biofouling_exposure_score", "predicted_cleaning_opportunity_score", "target_vessels_count", "validation_status", "drop constraint if exists vessel_snapshots_snapshot_date_vessel_id_port_key"]) {
