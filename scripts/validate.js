...
if (!dbLib.includes('.from("vessel_entities")') || !dbLib.includes('.from("risk_history")') || !dbLib.includes('.from("vessel_events")') || !dbLib.includes('.from("data_collection_runs")') || !dbLib.includes('.from("active_dataset_pointer")') || !dbLib.includes('.from("port_call_master")') || !dbLib.includes('.from("opportunity_master")') || !dbLib.includes('.from("vessel_snapshot_daily")') || !dbLib.includes('.from("port_snapshot_daily")') || !dbLib.includes('.from("operator_snapshot_daily")') || !dbLib.includes('.from("route_snapshot_daily")') || !dbLib.includes('.from("commercial_opportunity_daily")') || !dbLib.includes('.from("raw_archive_index")') || !dbLib.includes('.from("enrichment_match_candidates")') || !dbLib.includes('.from("commercial_leads")') || !dbLib.includes('.from("feature_store")') || !dbLib.includes('.from("rule_evaluations")') || !dbLib.includes('.from("model_training_rows")')) {
